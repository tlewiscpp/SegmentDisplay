...
#ifndef SEGMENTDISPLAY_GLOBALDEFINITIONS_H
#define SEGMENTDISPLAY_GLOBALDEFINITIONS_H
#include "MessageLogger.h"

const char * const PROGRAM_NAME{"SegmentDisplay"};
const char * const COMPANY_NAME{"Tyler Lewis"};
const char * const PROGRAM_LONG_NAME{"SegmentDisplay"};
const char * const PROGRAM_DESCRIPTION{"SegmentDisplay"};
...
#endif //SEGMENTDISPLAY_GLOBALDEFINITIONS_H
